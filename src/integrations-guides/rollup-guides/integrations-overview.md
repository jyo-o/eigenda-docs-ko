...
## Trusted Integration (분산+조회) {#trusted-integration}
...
## Cert 적시성 검증 (Cert Punctuality Verification)
...
### Pessimistic Cert 검증 (Pessimistic)
...
## Blob Commitment 검증 (Blob Commitment Verification)
