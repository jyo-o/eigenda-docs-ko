...
### Chunk Assignment Algorithm (청크 할당 알고리즘)
...
### Safety / Liveness 분석 (Safety and Liveness Analysis)
...
### Encoding Rate와 Security Threshold
...
## Cryptoeconomic Security Model (암호경제 보안 모델)
...
## Token Toxicity Security Model (토큰 toxicity 보안 모델)
